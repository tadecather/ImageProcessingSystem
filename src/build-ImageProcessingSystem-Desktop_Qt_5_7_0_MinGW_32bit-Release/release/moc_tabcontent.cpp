...
#include "../../ImageProcessingSystem/Display/tabcontent.h"
...
QT_MOC_LITERAL(1, 11, 27), // "changeFocusImageDisplaySlot"
QT_MOC_LITERAL(2, 39, 0) // ""

    },
    "TabContent\0changeFocusImageDisplaySlot\0"
    ""
};
...
void TabContent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TabContent *_t = static_cast<TabContent *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeFocusImageDisplaySlot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
